...
public class Account extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebaseRef = new Firebase(ImportantMethods.FIREBASE_URL);
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position){
            case 0:
                objFragment = new ProfilePage();
                break;
            case 1:
                objFragment = new DirectMessages();
                break;
            case 2:
                objFragment = new AddClass();
                break;
            case 3:
                objFragment = new RemoveClass();
                break;
            case 4:
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((Account) activity).onSectionAttached(
